...
template <typename t>
t& _get_parameters(t& params, ParamFilter* filter, SigmaXParameter& x, SigmaYParameter& y, RhoParameter& r) {
...
GaussianParametricEllipse::GaussianParametricEllipse(std::shared_ptr<SigmaXParameter> sigma_x,
