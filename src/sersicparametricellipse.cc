...
template <typename t>
t& _get_parameters(t& params, ParamFilter* filter, ReffXParameter& x, ReffYParameter& y, RhoParameter& r) {
...
SersicParametricEllipse::SersicParametricEllipse(std::shared_ptr<ReffXParameter> size_x,
