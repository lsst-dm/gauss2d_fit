 ...
 */
class EllipticalComponent : public Chromatic, public Component {
public:
    /**
     * Construct an EllipticalComponent from Parameter containers
     *
     * @param ellipse The ellipse Parameter container
     * @param centroid The per-channel centroid Parameters; default-constructed if null
    ...
    const MultiChannelCentroid& get_centroid() const;
